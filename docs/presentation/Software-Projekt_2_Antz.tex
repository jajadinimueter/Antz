...
\frame{
\frametitle{Hilfsmittel und Kommunikation}
  \begin{itemize}
    \item Repository auf GitHub (\url{https://github.com/jajadinimueter/antz})
    \item Projektplanung mit TargetProcess (\url{http://www.tpondemand.com})
    \item LaTeX-Vorlage von Matthias Pospiech (\url{http://www.matthiaspospiech.de})
    \item E-Mail, Chat, direkte Treffen, etc.
  \end{itemize}
}
