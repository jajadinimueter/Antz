...
\frametitle{Hilfsmittel/Vorgehen}
  \begin{itemize}
    \item Repository auf GitHub
    \item Projektplanung mit TargetProcess (www.tpondemand.com)
    \item LaTeX-Vorlage von Matthias Pospiech
    \item E-Mail, Chat, direkte Treffen
  \end{itemize}
}
