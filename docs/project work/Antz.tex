...
]{scrbook} % Classes: scrartcl, scrreprt, scrbook	%%% Change to scrartcl???
...
\includeonly{
 content/0-title,
 content/0-Abstract,
 content/1-Einfuehrung,
 content/2-Projekt,
 content/3-Applikation,
 content/4-Fazit,
 content/5-Zusammenfassung,
 content/Z-Appendix,
 content/Z-Publications,
} % end includeonly
...
%
\include{content/1-Einfuehrung}
\include{content/2-Projekt}
\include{content/3-Applikation}
\include{content/4-Fazit}
\include{content/5-Zusammenfassung}
