...
???
Kurzer Kommentar über die Abweichungen zwischen Schätzung und effektivem
Aufwand. \\
...
\begin{tabular}{| p{12cm} | c | c |}
  ...
  1\,pt &1\,pt \\
  \hline
  As a user I expect the ant collecting the food with most glucose content
first. & 2\,pt &2\,pt \\
  \hline
  As a user I expect the ants collecting the food. Means the amount of food
decreases over time. & 2\,pt & 2\,pt \\
  \hline
