...
Das heisst, dass bei längeren Pfaden generell weniger Pheromone platziert werden. Der Exponent $\gamma$ verstärkt die Unterschiede zwischen den Mengen, genau wie das $\alpha$ in der Formel zur Berechnung der Wahrscheinlichkeiten. Die Pfadlänge muss konstant $> 1$ sein. Dies kann bei der Erstellung des Graphen sichergestellt werden.
