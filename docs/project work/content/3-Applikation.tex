...
\caption{Starten durch Doppelklick auf main.exe} \end{figure}
...
\begin{description}
\item[1] Die Anzahl Ameisen kann hier eingestellt werden. Es wird empfohlen, der
...
die Kante mit den wenigsten Kosten entscheiden. Bei einem sehr hohen Wert, z.B.
...
Sobald ein Graph mit Reset oder Start generiert wurde, können mit der linken
