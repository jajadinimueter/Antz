...
Ziele dieses Softwareprojekts sind unter anderem, unser bisheriges Wissen in der
Praxis anzuwenden und unsere Programmierkenntnisse zu vertiefen. Ebenso soll die
eigene Erfahrung im   Projektmanagement vertieft werden (Planung, Schätzung,
Arbeitsteilung).
...
werden die Erkenntnisse aus dem Projekt dargestellt, bevor eine Zusammenfassung
folgt.

\noindent Insbesondere danken wir Syrus Mozafar für die hilfreiche
